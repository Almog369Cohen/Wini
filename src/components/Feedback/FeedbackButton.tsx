...
const FEEDBACK_TYPES: { type: FeedbackItem['type']; label: string; emoji: string; color: string; bg: string; Icon: typeof Lightbulb }[] = [
  { type: 'idea', label: 'רעיון חדש', emoji: '💡', color: '#059669', bg: '#d1fae5', Icon: Lightbulb },
  { type: 'improvement', label: 'שיפור', emoji: '🔧', color: '#0891b2', bg: '#cffafe', Icon: Wrench },
  { type: 'bug', label: 'באג / תקלה', emoji: '🐛', color: '#dc2626', bg: '#fee2e2', Icon: Bug },
  { type: 'other', label: 'אחר', emoji: '💬', color: '#7c3aed', bg: '#ede9fe', Icon: MessageCircle },
];
              ...
              <div className="flex gap-2 mb-4">
                {FEEDBACK_TYPES.map(ft => (
                  <button
                    ...
                    style={{
                      backgroundColor: selectedType === ft.type ? ft.bg : 'transparent',
                      color: selectedType === ft.type ? ft.color : '#9ca3af',
